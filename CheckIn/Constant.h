...
#define FIELD_CHECK_IN_PIC_FID @"453"
#define FIELD_CHECK_OUT_PIC_FID @"454"

#define FIELD_CHECK_IN_PROJECT_FID @"336"   //446
#define FIELD_CHECK_IN_WORKER_FID @"54"    //447
#define FIELD_CHECK_IN_START_TIME_FID @"448"  //450
#define FIELD_CHECK_IN_END_TIME_FID @"449"
#define FIELD_CHECK_IN_PIC_START_FID @"451"  //455
#define FIELD_CHECK_IN_PIC_END_FID @"452"   //456
#define FIELD_CHECK_IN_COST_CODE_FID @"456"   //454
#define FIELD_CHECK_OUT_FLAG_FID @"455"    //448
#define FIELD_CHECK_IN_EMPLOYEE_NAME_FID @"447"
#define FIELD_CHECK_IN_HOURWORKED_FID @"450"
#define FIELD_CHECK_IN_DATE_FID @"364"
